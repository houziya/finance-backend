(function(w) {
	var refresher = {
		...
		init: function(parameter) {
			...
			var list = document.querySelector("#"+parameter.box)
		...
		onScrolling: function(e, pullDownEl, pullUpEl, pullUpOffset) {
			...
			if (e.scrollerH < e.wrapperH && e.y < (e.minScrollY - pullUpOffset) || e.scrollerH > e.wrapperH && e.y < (e.maxScrollY - pullUpOffset)-100) {

<?php
  ...
  *
  */
class model_finance_logDay extends model
{
    protected $tableName = 'financial_log_day';
     ...
     * @author Baijiansheng
     */
    public function getFinancialDayLogs($condition, $start = 0, $length = 10, $fields = '*', $order = '')
    {

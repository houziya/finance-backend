...
<div class="pad-10">
    ...
    <div class="table-form">
       <form action="" method="post" id="form1">
        <input name="id" type="hidden" class="input-text" id="id" value="<{$info.id}>" /> 
        <input name="cid" type="hidden" class="input-text" id="cid" value="<{$info.cid}>" /> 
        <table width="100%">
              <tr>
                <th width="8%"><b>查询类型:</b></th>
                <td width="80%" colspan="3"> <input name="data[qu_type]" onchange="frequencyA()" type="radio" value="1" <if condition="$info.qu_type eq 1"> checked="checked"</if> /> 
					分钟&nbsp;
            ...
            <tr id="frequency" style='display:<if condition="$info.qu_type eq 6">none</if>'>
                ...
                <td width="88%" style="padding-left:0px;"><input    type="text"  name="data[qu_frequency]" id="qu_frequency"  readOnly="true" value="<{$info.qu_frequency}>"   class="input-text" /><!--<span id="msg" style="color:red"></span>--></td>
            </tr>
            <tr>
            ...
            <if condition="$info.update_time neq '0'">
                ...
                <td width="80%" colspan="3"><{$info.update_time|date='Y-m-d H:i:s',###}></td>
               </tr>
            <else/>
             <tr>
                <th width="8%"><b>添加时间:</b></th>
                <td width="80%" colspan="3"><{$info.add_time|date='Y-m-d H:i:s',###}></td>
            </tr>
            </if>
        </table>
        <div class="btn">

...
<div class="pad-10">
	...
	<div class="table-form">
		...
		<table width="100%">
			...
			<tr style="background:#D8FBFE">
				<th>免打扰</th>
				<td><input name="data[is_work]" type="radio" value="1" <if condition="$info['is_work'] eq 1"> checked="checked"</if> /> 
					开启 
						<input name="data[is_work]" type="radio" value="0" <if condition="$info['is_work'] eq 0"> checked="checked"</if> />
				关闭</td>
			</tr>
			<tr>
				<th>前台显示状态</th>
				<td><input name="data[is_show]" type="radio" value="1" <if condition="$info['is_show'] eq 1"> checked="checked"</if> /> 
					显示 
					<input name="data[is_show]" type="radio" value="0" <if condition="$info['is_show'] eq 0"> checked="checked"</if> />
					隐藏</td>
			</tr>
			<tr>
				<th>状态</th>

...
<div class="pad-10">
	...
	<div class="table-form">
		...
		<table width="100%">
			...
			<tr>
				<th>SQL</th>
				<td><textarea name="data[sql]" style="width:90%; height:60px"></textarea><br /><strong>注意：SQL里面必须包含uid字段</strong></td>
			</tr>
			<tr style="background:#E8E8E8">
				<th>站内信提醒</th>
				<td><input name="data[enable_message]" type="radio" value="1" checked="checked" /> 
					开启 
						<input name="data[enable_message]" type="radio" value="0" />
				关闭</td>
			</tr>
			<tr style="background:#E8E8E8">
				<th>站内信标题模版</th>
				<td><input name="data[tpl_message_title]" type="text" class="input-text" style="width:80%" /></td>
			</tr>
			<tr style="background:#E8E8E8">
				<th>站内信内容模版</th>
				<td><textarea name="data[tpl_message]" style="width:90%; height:60px"></textarea></td>
			</tr>
			<tr style="background:#FFDFE7">
				<th>邮件提醒</th>
				<td><input name="data[enable_email]" type="radio" value="1" checked="checked" /> 
					开启 
						<input name="data[enable_email]" type="radio" value="0" />
				关闭</td>
			</tr>
			<tr style="background:#FFDFE7">
				<th>邮件标题模版</th>
				<td><input name="data[tpl_email_title]" type="text" class="input-text" style="width:80%" /></td>
			</tr>
			<tr style="background:#FFDFE7">
				<th>邮件内容模版</th>
				<td><textarea name="data[tpl_email]" style="width:90%; height:200px"></textarea></td>
			</tr>
			<tr style="background:#D8FBFE">
				<th>手机提醒</th>
				<td><input name="data[enable_mobile]" type="radio" value="1" checked="checked" /> 
					开启 
						<input name="data[enable_mobile]" type="radio" value="0" />
				关闭</td>
			</tr>
			<tr style="background:#D8FBFE">
				<th>手机内容模版</th>
				<td><textarea name="data[tpl_mobile]" style="width:90%; height:60px"></textarea></td>
			</tr>
			<tr>
				<th>描述</th>
				<td><textarea name="data[content]" style="width:90%; height:60px"></textarea></td>
			</tr>
			<tr>
				<th>状态</th>

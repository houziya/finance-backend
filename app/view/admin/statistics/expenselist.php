...
<div class="pad-10">
    ...
    <div class="explain-col mar-b8" id="search_form">
        <form name="search_form" action="" method="post" id="search_form">
            软件名称：
            <input name="search[name]" type="text" class="input-text" value="<{$name}>" size="10" />
            手机号：
            <input name="search[mobile]" type="text" class="input-text" value="<{$mobile}>" size="10" />
            店名：
            <input name="search[subbranch]" type="text" class="input-text" value="<{$subbranch}>" size="10" />
            &nbsp;

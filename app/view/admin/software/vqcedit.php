...
<div class="pad-10">
    ...
    <div class="table-form">
        <form action="" method="post" id="form1">
            ...
            <input name="vid" type="hidden" class="input-text" id="vid" value="<{$info.vid}>" />
            ...
            <table width="100%">		
                ...
                <tr>
                    <th>数据库类型</th>
                    <td colspan="3"><input name="data[db_type]" type="radio" value="1" <if condition="$info.db_type eq 1"> checked="checked"</if> /> 
                Mysql&nbsp;

...
class helper_date {
	...
	protected $minute; //分
	protected $second; //秒
	protected $weekday; //星期的数字表示
	protected $cWeekday; //星期的完整表示
	protected $yDay; //一年中的天数 0－365
	protected $cMonth; //月份的完整表示
	protected $CDATE; //日期CDATE表示
	protected $YMD; //日期的YMD表示
	protected $CTIME; //时间的输出表示

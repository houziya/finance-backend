...
//
//$TimeStamp = helper_google2fa::get_timestamp();
//$secretkey = helper_google2fa::base32_decode($InitalizationKey); // Decode it into binary
//$otp = helper_google2fa::oath_hotp($secretkey, $TimeStamp); // Get current token
//
...
//
//
//$result = helper_google2fa::verify_key($InitalizationKey, "337952");
//
//var_dump($result);
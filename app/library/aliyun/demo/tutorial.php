...
$oss_sdk_service = new aliyun_oss();
...
function create_bucket($obj){
	$bucket = 'invalidxml3';
	//$acl = aliyun_oss::OSS_ACL_TYPE_PRIVATE;
	$acl = aliyun_oss::OSS_ACL_TYPE_PUBLIC_READ;
	//$acl = aliyun_oss::OSS_ACL_TYPE_PUBLIC_READ_WRITE;
...
function get_bucket_acl($obj){
	$bucket = 'phpsdk1349849394';
	$options = array(
		aliyun_oss::OSS_CONTENT_TYPE => 'text/xml',
	);
...
function  set_bucket_cors($obj){
	...
	$cors_rule[aliyun_oss::OSS_CORS_ALLOWED_HEADER]=array("x-oss-test");
	$cors_rule[aliyun_oss::OSS_CORS_ALLOWED_METHOD]=array("GET");
	$cors_rule[aliyun_oss::OSS_CORS_ALLOWED_ORIGIN]=array("http://www.b.com");
	$cors_rule[aliyun_oss::OSS_CORS_EXPOSE_HEADER]=array("x-oss-test1");
	$cors_rule[aliyun_oss::OSS_CORS_MAX_AGE_SECONDS] = 10;
...
function upload_by_content($obj){
	$bucket = 'invalidxml3';
	$content = '这是文本内容啊，这是文本内容啊，这是文本内容啊，这是文本内容啊';
...
function get_object($obj){
	...
	$options = array(
		aliyun_oss::OSS_FILE_DOWNLOAD => "d:\\cccccccccc.sh",
		//aliyun_oss::OSS_CONTENT_TYPE => 'txt/html',
	);	
...
function upload_by_multi_part($obj){
	...
	$options = array(
		aliyun_oss::OSS_FILE_UPLOAD => $filepath,
		'partSize' => 5242880,
	);
